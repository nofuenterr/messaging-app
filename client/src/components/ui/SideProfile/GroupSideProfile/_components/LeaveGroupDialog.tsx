...
export default function LeaveGroupDialog({ children, onLeave }: LeaveGroupProps) {
  return (
    <AlertDialog.Root>
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content className="bg-dark-500 border-dark-400 fixed top-1/2 left-1/2 z-100 grid max-h-[85vh] w-full max-w-120 -translate-1/2 gap-2 overflow-y-auto rounded-2xl border p-6 duration-150 focus:outline-none">
          <AlertDialog.Title className="mt-4 text-2xl font-bold">
            Confirm Leave Group
          </AlertDialog.Title>
          ...
          <div className="mt-6 flex items-center justify-between gap-4">
            ...
            <AlertDialog.Action asChild onClick={onLeave}>
              <span>
